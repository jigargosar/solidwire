...
export default function App() {
    ...
    const rectDrawable = createMemo(() =>
        generator.rectangle(300, 100, 200, 150, {
            roughness: 1.2,
            stroke: strokeColor,
            strokeWidth: 2
        })
    ...
    const miniRect = createMemo(() =>
        generator.rectangle(10, 5, 60, 30, {
            roughness: 1.0,
            stroke: strokeColor,
            strokeWidth: 1.5
        })
    ...
    return (
        <main class="relative h-screen w-screen overflow-hidden bg-gray-200 font-sans text-gray-900">
            ...
            <svg class="h-full w-full block bg-gray-100">
                ...
                <g class="cursor-move">
                    <path d={toPath(rectDrawable())} fill="none" stroke={strokeColor} stroke-width="2.5" />
                </g>
